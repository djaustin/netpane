import {
    ...
    InputLeftAddon,
    InputProps,
    StackProps, useColorModeValue
} from "@chakra-ui/react";
import { useRouter } from "next/router";
import React, { useState } from "react";
import { FiArrowRight, FiSearch } from "react-icons/fi";

type SearchInputProps = { hasButton?: boolean, inputProps?: InputProps, inputGroupProps?: InputGroupProps } & StackProps;

const SearchInput: React.FC<SearchInputProps> = ({hasButton, inputProps, inputGroupProps, ...stackProps}) => {
...
const backgroundColor = useColorModeValue('gray.200', 'gray.800')
  ...
  return (
    <HStack align='baseline' {...stackProps}>
      ...
      { hasButton && <Button onClick={searchIfValue}>
        <FiArrowRight />
      </Button>
}
    </HStack>
