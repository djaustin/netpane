...
const serverDescriptors = ['App Server' , 'Repository' , 'Build Server' , 'Web Server' , 'Proxy' , 'Elasticsearch' , 'Oracle Database' , 'PostgreSQL Database' , 'Tomcat Server' , 'Mesos Server'] as const
...
const descriptors: {descriptor: ServerDescriptor, count: ServerNumber}[] = serverDescriptors.map(e => ({descriptor: e, count: 0}))
